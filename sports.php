	...
	<div class="container">
		...
		<div id="navbar-collapse-02" class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				<li class="propClone"><a href="allproducts.php">All</a></li>
				<li class="propClone"><a href="books.php">Books</a></li>
				<li class="propClone"><a href="clothing.php">Clothing</a></li>
				<li class="propClone"><a href="electronics.php">Electronics</a></li>
				<li class="propClone"><a href="furniture.php">Furniture</a></li>
				<li class="propClone"><a href="sports.php">Sports</a></li>
				<li class="propClone"><a href="others.php">Others</a></li>
			...
			<div class="col-md-4">
				<div class="productbox">
					<div class="fadeshop">
						...
						<span class="maxproduct"><img src="<?php echo $result['photo']; ?> " height="350px" width="350px" ></span>
					</div>
